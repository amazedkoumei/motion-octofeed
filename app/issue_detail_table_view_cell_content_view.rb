# -*- coding: utf-8 -*-
class IssueDetailTableViewCellContentView < UIView
  ...
  def drawRect(rect)
    ...
    "#{@cell.issue[:user][:login]}".drawInRect(commentsRect, withFont:@commentsFont, lineBreakMode:NSLineBreakByWordWrapping)
    ...
    @cell.issue[:body].drawInRect(titleRect, withFont:@titleFont, lineBreakMode:NSLineBreakByWordWrapping)
